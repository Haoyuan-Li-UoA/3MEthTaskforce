...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    if args.load_test_configs:
        load_link_prediction_test_configs(args=args)

    return args


def load_link_prediction_test_configs(args: argparse.Namespace):
    """
...
def load_node_classification_test_configs(args: argparse.Namespace):
    """

...
def preprocess_data(dataset_name: str, bipartite: bool = True, node_feat_dim: int = 172):
    ...
    PATH = '../Origin Data/{}/{}.csv'.format(dataset_name, dataset_name)
...
def check_data(dataset_name: str):
    ...
    """
    # original data paths
    origin_OUT_DF = '../Origin Data/{}/ml_{}.csv'.format(dataset_name, dataset_name)
    origin_OUT_FEAT = '../Origin Data/{}/ml_{}.npy'.format(dataset_name, dataset_name)
    origin_OUT_NODE_FEAT = '../Origin Data/{}/ml_{}_node.npy'.format(dataset_name, dataset_name)
...
if args.dataset_name in ['enron', 'SocialEvo', 'uci']:
    ...
    if args.dataset_name not in ['crypto']:

...
def original_data_treatment(token_num=200,
    ...
    standard_transaction_token_recording = transform_save_data(transaction_token_recording.copy(), feature_combination="transaction_token_recording")
    ...
    transform_save_data(transaction_global.copy(), feature_combination="transaction_global")
    ...
    transform_save_data(transaction_textual.copy(), feature_combination="transaction_textual")
    ...
    standard_transaction_token_global_recording = transform_save_data(transaction_token_global_recording.copy(), feature_combination="transaction_token_global_recording")
    ...
    standard_transaction_token_all = transform_save_data(transaction_token_all.copy(), feature_combination="transaction_token_all")

    print("Generate Price Prediction Data")
    generate_price_prediction_data(standard_transaction_token_recording.copy(), "price_prediction_transaction_token_recording")
    print("price_prediction_transaction_token_recording completed")
    generate_price_prediction_data(standard_transaction_token_global_recording.copy(), "price_prediction_transaction_token_global_recording")
    print("price_prediction_transaction_token_global_recording completed")
    generate_price_prediction_data(standard_transaction_token_all.copy(), "price_prediction_transaction_token_all")
    print("price_prediction_transaction_token_global_recording completed")
